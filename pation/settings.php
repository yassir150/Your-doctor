...
<body>
    ...
    if (!isset($_COOKIE['user_email']) || !isset($_COOKIE['user_type']) || $_COOKIE['user_type'] != 'p') {
        // Redirect to login page if cookies are missing or user type is not "p"
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-appoinment ">
                        <a href="consultation.php" class="non-style-link-menu menu-active "><div><p class="menu-text">Mes réservations</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-settings menu-active menu-icon-appoinment-active">
                        <a href="settings.php" class="non-style-link-menu menu-active non-style-link-menu-active"><div><p class="menu-text">Paramètres</p></a></div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <!-- the one bellow is for edit account -->
                            <tr>
                                <td style="width: 25%;">
                            ...
                            <!-- the one bellow is for the view detale  -->
                            <tr>
                            <td style="width: 25%;">
                            ...
                            <!-- the one bellow is for delete(drop) account -->
                            <tr>
                            <td style="width: 25%;">
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Date de naissance: </label>
            ...
            $error_1=$_GET["error"];
                $errorlist= array(
                    '1'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Vous disposez déjà un compte pour cette adresse e-mail.</label>',
